...
class SerieController {
        ...
        $(".list-generic li.vertical").each(function(i, el) {
          ...
          let serie = {
            ...
            thumb: $(this)
              ...
              .attr("src"),
            name: `${$(this)
              .find(".searchCard a.f16")
              .attr("href")
              .replace("/serie/", "")}`,
            link: `https://www.minhaserie.com.br${$(this)
              .find(".searchCard a.f16")
              .attr("href")}`,
            stars:
              $(this)
  ...
  top(req, res) {
    let options = st.setURI(
      `https://www.minhaserie.com.br/series${
        req.query.page ? `?page=${req.query.page}` : ""
      }`
    );
        ...
        $(".tv-list .vertical").each(function(i, el) {
          ...
          let serie = {
            ...
            category: `${$(this)
              ...
              .trim()}`,
            rank: $(this)
              .find(".front .info-rate span")
              .text()
              .trim(),
            thumb: `${$(this)
              .find(".front span.image.w190 img")
              .attr("src")}`,
            name: `${$(this)
              .find(".back a")
              .attr("href")
  ...
  show(req, res) {
    let options = st.setURI(
      `https://www.minhaserie.com.br/serie/${req.params.name}`
    );
